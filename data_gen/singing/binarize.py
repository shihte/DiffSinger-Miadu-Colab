...
class MidiSingingBinarizer(SingingBinarizer):
    ...
    @staticmethod
    def get_align(ph_durs, mel, phone_encoded, res, hop_size=None, audio_sample_rate=None):
        if hop_size is None: hop_size = hparams['hop_size']
        if audio_sample_rate is None: audio_sample_rate = hparams['audio_sample_rate']
